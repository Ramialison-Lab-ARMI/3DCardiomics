...
public class dPanel : MonoBehaviour {
	...
	public GameObject DD; // Dropdown holder
	public GameObject SH; // Script holder
	...
	public void generateTable (string geneName) {
		...
		for (int i=upTo; i < upTo+max; i++) {
			...
			btn.onClick.AddListener(delegate { btnAction(gName); });
	...
	public void btnAction(string gName){  // Function linked to button which uses ColourFromText in Colour class
